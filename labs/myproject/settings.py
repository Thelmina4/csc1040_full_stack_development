...
SECRET_KEY = 'django-insecure-iuhr=dtzq+jz^yxl9dxa6q+r53*@nwo9*3f2wr(j5sdx1h#pzw'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# A list of domain names this site can serve.
#  Empty during development, but must be set in production.
ALLOWED_HOSTS = []
